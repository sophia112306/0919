	...
	public void costOfTheMeal() {
		...
		try {
			...
			for (int i = 0; i < secondRow.getLastCellNum(); i++) {
				...
				} if (cell.getNumericCellValue() <= 100 && cell.getNumericCellValue() > 70) {
					Row firstRow = sheet.getRow(0);
					Row thirdRow = sheet.getRow(2);
					Row fifthRow = sheet.getRow(4);
				...
				} if (cell.getNumericCellValue() <= 200 && cell.getNumericCellValue() > 100) {
					Row firstRow = sheet.getRow(0);
					Row thirdRow = sheet.getRow(2);
					Row fifthRow = sheet.getRow(4);
				...
				} if (cell.getNumericCellValue() > 200) {
					Row firstRow = sheet.getRow(0);
					Row thirdRow = sheet.getRow(2);
					Row fifthRow = sheet.getRow(4);
